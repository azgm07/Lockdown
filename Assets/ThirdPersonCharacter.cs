...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		[SerializeField] float m_StationaryTurnSpeed = 60;
		...
		public void Move(Vector3 move, bool crouch, bool jump, bool attack, bool death, bool standing)
		{
        ...
        void Attacking(bool attack)
        {
            if (m_IsGrounded && attack)
            {
                m_Attacking = true;
            }
            else
		...
		public void UpdateAnimator(Vector3 move)
		{
            ...
            m_Animator.SetBool("Standing", m_Standing);
